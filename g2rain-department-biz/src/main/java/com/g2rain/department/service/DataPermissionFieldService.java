...
public interface DataPermissionFieldService {
     ...
     * @return VO 对象列表
     */
    List<DataPermissionFieldVo> selectList(DataPermissionFieldSelectDto selectDto);
     ...
     * @return 分页 VO 数据
     */
    PageData<DataPermissionFieldVo> selectPage(PageSelectListDto<DataPermissionFieldSelectDto> selectDto);
     ...
     * @return 操作结果（影响行数）
     */
    Long save(DataPermissionFieldDto dto);
