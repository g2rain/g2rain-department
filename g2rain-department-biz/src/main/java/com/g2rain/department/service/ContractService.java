...
public interface ContractService {
     ...
     * @return VO对象列表
     */
    List<ContractVo> selectList(ContractSelectDto selectDto);
     ...
     * @return 分页VO数据
     */
    PageData<ContractVo> selectPage(PageSelectListDto<ContractSelectDto> selectDto);
