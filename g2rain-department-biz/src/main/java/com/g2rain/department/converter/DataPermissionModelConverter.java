...
public interface DataPermissionModelConverter {

    /**
     * 单例实例，通过 {@link Mappers#getMapper(Class)} 获取 MapStruct 自动生成的实现。
     */
    DataPermissionModelConverter INSTANCE = Mappers.getMapper(DataPermissionModelConverter.class);
    ...
    DataPermissionModelVo po2vo(DataPermissionModelPo po);
    ...
    DataPermissionModelPo dto2po(DataPermissionModelDto dto);
}
