...
public interface DataPermissionGroupConverter {

    /**
     * 单例实例，通过 {@link Mappers#getMapper(Class)} 获取 MapStruct 自动生成的实现。
     */
    DataPermissionGroupConverter INSTANCE = Mappers.getMapper(DataPermissionGroupConverter.class);
    ...
    DataPermissionGroupVo po2vo(DataPermissionGroupPo po);
    ...
    DataPermissionGroupPo dto2po(DataPermissionGroupDto dto);
}
