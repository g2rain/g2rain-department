...
public interface DataPermissionFieldConverter {

    /**
     * 单例实例，通过 {@link Mappers#getMapper(Class)} 获取 MapStruct 自动生成的实现。
     */
    DataPermissionFieldConverter INSTANCE = Mappers.getMapper(DataPermissionFieldConverter.class);
    ...
    DataPermissionFieldVo po2vo(DataPermissionFieldPo po);
    ...
    DataPermissionFieldPo dto2po(DataPermissionFieldDto dto);
}
